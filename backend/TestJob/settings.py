...
SECRET_KEY = 'django-insecure-nmuh!3%(=$8y)ltz!-ox83-ob3b$tsu39%94tz9-z5r!4y4=kh'
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),  # Type of token in the authorization header
}
